...
<!-- PRDs:
- https://katalon.atlassian.net/wiki/spaces/ADMIN/pages/3652714586/PRD+Seat-Based+KSE+-+License+Assignment+Activation+History
- https://katalon.atlassian.net/wiki/spaces/ADMIN/pages/3689481692/PRD+Seat-based+KSE+-+Assignment+Details
- https://katalon.atlassian.net/wiki/spaces/ADMIN/pages/3689481749/PRD+Seat-Based+KSE+-+License+Usage+History+Chart 
-->
Learn about Katalon Studio Enterprise (KSE) license utilization reports (seat-based) in Katalon TestOps.
...
## Seat-Based: KSE - License Assignment and Activation History

The KSE License Assignment and Activation History chart provides a comprehensive visualization of license allocation and user activation trends across your Account or Organization. This feature helps you monitor license utilization, identify usage patterns, and optimize resource allocation based on actual needs.
...
### View the Seat-Based: KSE - License Assignment and Activation History Report
...
2. Click on the **KSE - License Assignment and Activation History** report; it is immediately visible.
...
### View the KSE - License Assignment Details Table

1. Go to **Admin Settings > Account > License Utilization**. You can find Admin Settings at the upper right corner of the page, indicated by a cog icon.

2. Click on the **KSE - License Assignment Details** report; it is immediately visible.
...
### About the KSE - Assignment Details Table
...
### View the KSE - License Usage Report

1. Go to **Admin Settings > Account > License Utilization**. You can find Admin Settings at the upper right corner of the page, indicated by a cog icon.

2. Click on the **KSE - License Usage** report; it is immediately visible.
