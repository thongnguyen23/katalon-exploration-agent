...
<div xmlns="http://www.w3.org/1999/xhtml" className="note note note_note"><span className="note__title">Note:</span> <ul className="ul"><li className="li"><p className="p">Windows Desktop app testing is temporarily unavailable in Katalon Studio 10.x. Please use version 9.x to access this feature. For more details, refer to the 10.0.0 release notes.</p></li></ul></div>
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">   <img className="image" src={useBaseUrl("/04392fc0-2e88-11ed-9930-0242fe3e4a3f/ks-850-spy-win.png")} /></p> 

## <a id="id_5" class="anchor_top_offset"/>Record Windows Action

<p xmlns="http://www.w3.org/1999/xhtml" className="p">   <img className="image" src={useBaseUrl("/1aebbbc0-2e88-11ed-9930-0242fe3e4a3f/ks-record-win.png")} /></p> 
