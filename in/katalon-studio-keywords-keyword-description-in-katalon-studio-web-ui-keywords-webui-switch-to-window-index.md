...
Keyword name: `switchToWindowIndex`

:::note
Window index is counted by order of window's appearance and starts from 0. After switching, window index does not change: the first window still has index 0, the second window still has index 1 and so on.
:::
...
| --- | --- | --- | --- |
| index | int | Yes | The index of the window to switch to, the index is a 0-based number. |
